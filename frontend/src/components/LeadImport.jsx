                ...
                <tbody>{fileQueue.map((fq, idx) => (
                  <tr key={idx}>
                    ...
                    <td>{fq.vendor === 'Cheryl'
                      ...
                      : fq.vendor === 'HOFLeads'
                        ? <span style={{ fontFamily: 'var(--font-mono)', fontSize: '0.65rem', color: 'var(--text-muted)', padding: '0.2rem 0.4rem', display: 'inline-block' }} title="HOF tier is auto-assigned per lead from the Campaign Number column">Auto (by campaign)</span>
