...
from routers import ghl_cadence, cadence_sms, research, lead_hygiene, registry
...
app.include_router(registry.router, prefix="/api/admin/registry", tags=["Registry (admin, review-only)"])
